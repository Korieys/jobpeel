        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
            ...
            >
                ...
                <p className="text-zinc-400 text-lg max-w-md mb-3 leading-relaxed">
                    Score your resume against any job description and get AI-powered improvement suggestions.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-10 w-full max-w-lg">
                    {[
                        { label: "ATS Scoring", desc: "Know your score" },
                        { label: "Keyword Analysis", desc: "Find missing terms" },
                        { label: "AI Suggestions", desc: "Actionable fixes" },
                    ].map((feature, i) => (
                        <motion.div
                            key={feature.label}
