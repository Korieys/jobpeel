...
export default function LoginPage() {
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Handle specific firebase errors cleanly or just show generic
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-zinc-900/50 border border-white/5 backdrop-blur-xl rounded-2xl p-8 shadow-2xl">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-zinc-500 text-sm mt-2">Sign in to continue to your dashboard</p>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm text-zinc-500">
                        ...
                        <Link href="/signup" className="text-orange-500 hover:text-orange-400 font-bold hover:underline">
                            Sign up
                        </Link>
                    </div>
                </div>
